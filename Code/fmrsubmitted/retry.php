...
?>
<!-- This HTML makes the UI of retry page same as Login, refer to fmr-11052015 for previous version. -->
<!DOCTYPE html>
    ...
    <div class="login">
      ...
      <form method="POST" action="loginproc.php" id="tab">
        <p><input type="text" name="username" value = "" placeholder="Username" required></p>
          ...
          <p><input type="submit" value="Login"></p><p id="sorry">Sorry, the Username/Password is Incorrect. Please Try Again.</p>
