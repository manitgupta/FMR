...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Delete Responders|FMR</title>
	...
	<body>
		...
		<div class="content">
			...
			<p>Are you sure you want to delete the volunteer
				...
				echo $row['name'] ;
				?>?</p>
			<button><a href="deleteproc.php?id=<?php echo $id?>">Yes</a></button>
			<button><a href="view-responders.php">No</a></button>
		</div clas>
