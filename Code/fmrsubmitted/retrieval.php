...
<header>
  ...
  <section class="container">
    <div class="login">
      ...
      <form method="POST" action="retrievalproc.php" id="tab">
        <p><input type="text" name="email" value = "" placeholder="xyz@example.com" required></p>
          <p><input type="submit" value="Send"></p><p id="sorry">Your password will be emailed to you. Don't Refresh or Go Back.</p>
